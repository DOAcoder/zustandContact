            ...
            <div className="container">
                ...
                <div className="py-10">
                    ...
                    <div className="flex items-center justify-center flex-col gap-y-2 mb-4 w-[350px] mx-auto">
                        <input value={name} onChange={(e) => setName(e.target.value)} className="outline-none rounded-md w-full" type="text" placeholder="Name" />
                        <input value={phone} onChange={(e) => setPhone(e.target.value)} className="outline-none rounded-md w-full" type="number" placeholder="Phone" />
                        <input value={email} onChange={(e) => setEmail(e.target.value)} className="outline-none rounded-md w-full" type="email" placeholder="Email" />
                        <input value={telegram} onChange={(e) => setTelegram(e.target.value)} className="outline-none rounded-md w-full" type="text" placeholder="Telegram" />
                        <button onClick={addTask} className="hover:bg-indigo-400 w-full rounded-md px-5 py-2 bg-indigo-600 text-white">Add Contact</button>
                    </div>
                    ...
                    <ul className="flex flex-col gap-y-2">
                        {
                            ...
                            }): <h2 className=" border-[3px] border-gray-900 p-4 font-bold text-[50px] text-center">NO CONTACT</h2>
                        }
                    </ul>
                </div>
            </div>
